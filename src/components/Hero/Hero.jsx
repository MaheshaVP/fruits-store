  ...
  return <section>
    ...
    <div className='flex flex-col justify-center py-14 md:py-0 relative z-10 '>
      <div className='text-center md:text-left space-y-6 lg:max-w-[400px]'>
        ...
        initial="hidden"
        animate="visible"
        className='capitalize text-2xl tracking-wide'>
    ...
    <div className='flex justify-center items-center'>
      ...
      src={HeroPng} alt="HeroImg" className='w-[350px] md:w-[550px] drop-shadow'/>
    </div>

    {/* leaf image */}
    <div className='absolute top-14 md:top-0 right-1/2 blur-sm opacity-100 rotate-[40deg]'>
      <motion.img
